...
{#if gameDataStore.data === null}
	...
	>
		<div class="animate-in w-[60%] object-cover">
			<img src="micron_banner.png" alt="Micron banner" />
		</div>
		<hr class="animate-in w-[60%] bg-primary" />
		<div class="flex flex-col items-center justify-center gap-y-4 rounded-lg bg-muted p-4">
			<h2 class="h4 animate-in font-normal!">
			...
			<div class="flex w-fit flex-row gap-x-4">
				...
				<div class="animate-in"><Button variant="outline" href="about"><IconHelpCircle /> Learn more</Button></div>
			</div>
		</div>
		<div
			class="animate-in flex flex-col items-center justify-center gap-2 rounded-lg border-b border-primary bg-muted p-2 text-center"
		>
			<p class="animate-in text-gray-300">
